...
Requirement.create!(:description => 'Replace news text with references to appropriate controller instance variables. Your controller will now provide the news when the page is loaded.  You can fake text; anything will do.', :points => 2 )
